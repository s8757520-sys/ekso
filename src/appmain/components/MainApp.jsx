...
// ========== ЛИЧНЫЙ ЧАТ ==========
if (selectedChat) {
return ( <div className="h-screen bg-[var(--bg-primary)] flex flex-col overflow-hidden">
<button
onClick={() => setSelectedChat(null)}
className="p-3 text-blue-500 font-medium flex-shrink-0"
>
← Назад к чатам </button>
...
return ( <div className="min-h-screen bg-[var(--bg-primary)] flex flex-col"> <Sidebar
     ...
     /> <Header onMenuClick={toggleSidebar} /> <div className="flex-1 overflow-y-auto">
<ProfileScreen
nickname={nickname}
publicKey={publicKey}
lang={lang}
onBack={() => setCurrentScreen('chats')}
/> </div> <Footer activeTab={activeTab} onTabChange={setActiveTab} lang={lang} /> </div>
);
}
